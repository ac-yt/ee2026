...
module powerup_oled (input [6:0] pu_x, input [5:0] pu_y,
    ...
    localparam ROW0_CY  = 6'd20; //6'd16;
    localparam ROW1_CY  = 6'd35; //6'd32;
    localparam ROW2_CY  = 6'd51; //48;
...
//    wire [2:0] lbl_ly     = pu_y - 6'd2;
    ...
    always @(*) begin
        ...
        if (pu_y >= 1 && pu_y <= 9) oled_data_powerup = in_left_half ? `OLED_NAVY : `OLED_DARK_RED;
        else oled_data_powerup = `OLED_BLACK;
