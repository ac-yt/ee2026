...
module interface_fsm (input clk, btnL, btnR, btnC, btnU, btnD,
    ...
    // -------------------------------------------------------
    parameter BUTTON_HOME_SINGLE = 1'd0;
    parameter BUTTON_HOME_MULTI = 1'd1;
...
//    reg game_over = 0;
    reg game_over_single = 0;
    reg game_over_multi = 0;
...
//                        end
            ...
            `MULTI_WAIT_PAIR: begin
                ...
                if (prev_state != `MULTI_WAIT_PAIR) begin
                    multi_game_saved <= 0;
                    send_unpair_req <= 1;
                end
            end
                    ...
                    if (player == `PLAYER_1) begin
                        if (multi_game_saved && !game_over_multi) begin
                            ...
                            if (draw_letter(x, y, 33, 49, "R") ||
                                draw_letter(x, y, 39, 49, "E") ||
                                draw_letter(x, y, 45, 49, "S") ||
                                draw_letter(x, y, 51, 49, "U") ||
                                draw_letter(x, y, 57, 49, "M") ||
                                draw_letter(x, y, 63, 49, "E"))
                                oled_data <= (menu_cursor == BUTTON_MENU_RESUME) ? `OLED_YELLOW : `OLED_WHITE;
                        end
            ...
            `SINGLE_HOME: begin // same shared nav for single and multi
                ...
                if (pulse_btnC) begin
                    ...
                    case (menu_cursor)
                        ...
                        BUTTON_MENU_DIFFICULTY: next_menu_cursor = BUTTON_MENU_DIFFICULTY;
                        default: next_state = `HOME;
                    endcase
                end
            end
